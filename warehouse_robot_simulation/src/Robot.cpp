...
void Robot::Operate()
{
        ...
        case RobotStatus::dispatchOrder:
	{
            ...
            // Send robot back to fixed home position
	    geometry_msgs::Pose homePose;
	    homePose.position.x = -7.0;  // your desired base X
	    homePose.position.y = -7.0;  // your desired base Y
	    homePose.position.z = 0.0;

	    tf2::Quaternion q;
	    q.setRPY(0, 0, 0);
	    homePose.orientation.x = q.x();
	    homePose.orientation.y = q.y();
	    homePose.orientation.z = q.z();
	    homePose.orientation.w = q.w();
