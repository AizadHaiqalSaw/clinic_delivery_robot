...
{
    std::cout << "[ClinicSimulation] " << message << std::endl;
}
...
void LoadModels(std::shared_ptr<ModelController> &modelController, std::string projectDirectory)
{
    ...
    modelController->Add("Dispatch1", projectDirectory + "/models/warehouseObjects/Dispatch1.sdf");
    modelController->Add("Dispatch2", projectDirectory + "/models/warehouseObjects/Dispatch2.sdf");
    modelController->Add("Dispatch3", projectDirectory + "/models/warehouseObjects/Dispatch3.sdf");
    modelController->Add("Dispatch4", projectDirectory + "/models/warehouseObjects/Dispatch4.sdf");
    modelController->Add("Dispatch5", projectDirectory + "/models/warehouseObjects/Dispatch5.sdf");
    modelController->Add("Dispatch6", projectDirectory + "/models/warehouseObjects/Dispatch6.sdf");
    modelController->Add("Dispatch7", projectDirectory + "/models/warehouseObjects/Dispatch7.sdf");
}
...
bool InstatiateWarehouseObjects(std::vector<std::shared_ptr<Storage>> &storages, std::vector<std::shared_ptr<Dispatch>> &dispatches, std::shared_ptr<ModelController> modelController, std::string projectDirectory)
{
    ...
    try
    {
        ...
        std::ifstream storagesConfigFs(projectDirectory + "/configs/clinic_storages");
    ...
    try
    {
        ...
        std::ifstream dispatchesConfigFs(projectDirectory + "/configs/clinic_dispatches");
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "ClinicSimulation", ros::init_options::NoSigintHandler);
    ros::NodeHandle n;
